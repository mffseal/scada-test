...
def general_process(name, process_data, key):
    with open('temp/ref/ref_check.json') as ref_chk_file:
        ref_chk_json = json.load(ref_chk_file)

    with open('temp/log/' + name + '_log.json') as log_file:
...
def modbus_r():
    ...
    general_process('modbus_r', data, 'PDU')
...
def fins_udp_r():
    ...
    general_process('fins_udp_r', data, 'DATA')
...
def fins_udp_w():
    ...
    general_process('fins_udp_w', data, 'DATA')
...
def fins_tcp_r():
    ...
    general_process('fins_tcp_r', data, 'DATA')
...
def fins_tcp_w():
    ...
    general_process('fins_tcp_w', data, 'DATA')
