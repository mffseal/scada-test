...
class OmronFins(Protocol):
    def __init__(self):
        ...
        self.des_node_number = {'value': b'\x01', 'lens': 8, 'enabled': True}  # sysmac net / link
        ...
        self.num_of_items = {'value': b'\x00\x02', 'lens': 16, 'enabled': True}
        self.fill = {'value': b'\x00', 'lens': 80, 'enabled': False}
        self.data = {'value': b'\x00\x00\x00\x08', 'lens': 32, 'enabled': False}
